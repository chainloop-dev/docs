...
[Here](https://github.com/chainloop-dev/docs/blob/main/.github/workflows/deploy.yml) you can find a Github Action example where based on [this workflow contract](https://github.com/chainloop-dev/docs/blob/main/.github/workflows/chainloop-contract.cue) it

- Initializes the Chainloop attestation.
- Creates an SBOM using [syft](https://github.com/anchore/syft)
