...
import ContractYAML from '!!raw-loader!../reference/operator/contract-examples/advanced/contract.yaml';
import ContractCUE from '!!raw-loader!../reference/operator/contract-examples/advanced/contract.cue';
// See https://github.com/webpack-contrib/raw-loader/issues/91#issuecomment-648830498
import ContractJSON from "../reference/operator/contract-examples/advanced/contract.json.raw!=!raw-loader!../reference/operator/contract-examples/advanced/contract.json"
