...
import WorkflowContractIntro from '../../partials/_workflow-contract-intro.md';
import ContractYAML from '!!raw-loader!./contract-examples/advanced/contract.yaml';
import ContractCUE from '!!raw-loader!./contract-examples/advanced/contract.cue';
// See https://github.com/webpack-contrib/raw-loader/issues/91#issuecomment-648830498
import ContractJSON from "./contract-examples/advanced/contract.json.raw!=!raw-loader!./contract-examples/advanced/contract.json"
...
<Tabs>
   <TabItem value="yaml" label="yaml" default>
      <CodeBlock language="yaml" title="skynet.contract.yaml" showLineNumbers>{ContractYAML}</CodeBlock>
   </TabItem>
   <TabItem value="cue" label="cue">
      <CodeBlock language="cue" title="skynet.contract.cue" showLineNumbers>{ContractCUE}</CodeBlock>
   </TabItem>
   <TabItem value="json" label="json">
      <CodeBlock language="json" title="skynet.contract.json" showLineNumbers>{ContractJSON}</CodeBlock>
   </TabItem>
</Tabs>
...
|`type`|yes||<ul><li>`STRING` values will be injected in the attestation verbatim</li><li>`ARTIFACT` kinds will get uploaded to the built-in Content Addressable Storage (CAS) and then referenced by their **content digest**</li><li>`CONTAINER_IMAGE` kinds will get resolved and referenced by **repository digest**</li></ul>
