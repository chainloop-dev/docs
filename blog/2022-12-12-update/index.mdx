...
- Building a **new [Web User Interface](https://github.com/chainloop-dev/frontend) for Operators**. To simplify workflow onboarding, contract handling and enable observability features.
...
We are committed to making ChainLoop Open source. Currently, only the beta UI frontend [source code](https://github.com/chainloop-dev/frontend) is available, more pieces will be open-sourced soon.
