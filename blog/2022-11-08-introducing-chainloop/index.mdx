...
<Image img={require("./fragmentation.png")} className="light-mode-only" />
<Image img={require("./fragmentation-dark.png")} className="dark-mode-only" />
...
<Image img={require("./fragmentation-ssc.png")} className="light-mode-only" />
<Image
  img={require("./fragmentation-ssc-dark.png")}
